        ...
        <v-app app>
            ...
            <v-footer app padless style="padding: 10px 0; background-color: transparent;">
                <div class="pd_footer d-flex justify-center">
                    ...
                    <v-spacer></v-spacer>
                    &copy; 2020 
                    <a target="_blank" href="https://github.com/Pramod-Devireddy/covid19" title="GitHub" class="social__Item-sc-1iftnmx-1 dJZGSh">
                        &nbsp; PRAMOD DEVIREDDY 
                        <svg stroke="rgb(170, 170, 170)" fill="rgb(170, 170, 170)" stroke-width="0" viewBox="0 0 512 512" height="1.1em" width="1.1em" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <v-spacer></v-spacer>
                    <img class="counter" src="https://counter7.stat.ovh/private/freecounterstat.php?c=bacs55dkw44qfp1ktqtkx6nywqx516zy" border="0" title="hit counter" alt="hits">
